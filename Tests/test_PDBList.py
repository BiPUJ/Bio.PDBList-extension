...
class TestPDBListUpdatePDB(unittest.TestCase):
    """
    Test method responsible for weekly update local PDB repository.
    """
    def test_update(self):
        pdblist = PDBList()
        structures = pdblist.update_pdb()
        # TODO assertion
        pass


class TestPDBListDownloadAll(unittest.TestCase):
    """

    """

    def test_download_entire_pdb(self):
        pass

        # TODO dla ograniczonych listfile lub zmockowac tylko odczytywanie list

    def test_download_obsolete_entries(self):
        pass

    def get_seqres_file(self):
        pass

    # TODO download a set of files